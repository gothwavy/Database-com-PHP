...
<body>
  <div class="container">
    ...
    <div align="right">
      ...
      <?php } ?>
      <a href="carrinho.php?id_carrinho=<?php echo ($id_carrinho)?>"><img src="images/carrinho.jpg" width="60px"></a>
    </div>
      ...
      <div class="col">
        <form action="index.php" method="post" class="d-flex">
          ...
          <select name="categoria" class="form-control me-2">
            <option value="0" selected hidden>Categorias</option>
            <?php
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-center"> <!-- Centraliza o botão -->
                <a href="_cria_carrinho.php?id_cliente=<?php echo ($id_cliente) ?>&id_produto=<?php echo ($id_produto) ?>"
                  class="mt-auto btn btn-primary">Adicione ao carrinho</a>
              </div>
            </div>
          </div>
          </br>
